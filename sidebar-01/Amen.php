...
<div class="modal fade" id="demo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="mencode.php" method="POST" enctype="multipart/form-data">
...
<tbody>
  ...
  ?>
    ...
    <td><?php echo $row['price'] ?> </td>
        ...
        <td>
         <form action="menedit.php" method="POST">
            <input type="hidden" name="editid" value="<?php echo  $row['id'] ?>"/>
            <button type="submit" name="edit" class="btn btn-primary">Edit</button>
         </form>
      </td>
      <td>
         <form action="mencode.php" method="POST">
