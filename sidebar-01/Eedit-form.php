...
$id = $_POST['id'];
$q = "select * from electronic where id='$id'";
...
<body>
    ...
    <form method="post" action="Eedit_menu.php">
        <div class="mb-3">
...
<div class="mb-3">
  ...
  <input type="file" class="form-control" id="exampleFormControlInput1" name="image" value='<?php  echo $row1['image']?>'>
</div>
...
$id = $_POST['id'];
$q = "select * from shoes where id='$id'";
$result = mysqli_query($con,$q);
$num = mysqli_num_rows($result);
$row1 = mysqli_fetch_assoc($result);
 ?>
