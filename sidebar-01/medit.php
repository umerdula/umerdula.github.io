    ...
    <?php
        if (isset($_POST['edit']))
        {
            ...
            if($num>0)
            {
                ...
                ?>
             <form action="mcode.php" method="POST" enctype="multipart/form-data">
            ...
            <a href="Amobile.php"><button type="button" class="btn btn-secondary">Close</button> </a>
