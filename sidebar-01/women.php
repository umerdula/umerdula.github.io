    ...
    <div class="row">
      <div class="col-lg-3">
        <form action="manage_cart.php" method="POST">
          <div class="card">
            <img src="women1.jpg" class="card-img-top">
            <div class="card-body text-center">
              <h5 class="card-title">Blazer</h5>
              <p class="card- text">color:Light Blue</p>
      ...
      <div class="col-lg-3">
        <form action="manage_cart.php" method="POST">
          <div class="card">
            <img src="women2.jpg" class="card-img-top">
            <div class="card-body text-center">
              <h5 class="card-title">Blazer</h5>
      ...
      <div class="col-lg-3">
        <form action="manage_cart.php" method="POST">
          <div class="card">
            <img src="women3.jpg" class="card-img-top">
            <div class="card-body text-center">
       ...
       <div class="col-lg-3">
        <form action="manage_cart.php" method="POST">
          <div class="card">
            <img src="women4.jpg" class="card-img-top">
            <div class="card-body text-center">
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-lg-3">
        <form action="manage_cart.php" method="POST">
          <div class="card">
            <img src="women5.jpg" class="card-img-top">
            <div class="card-body text-center">
              <h5 class="card-title">Sherwani</h5>
              <p class="card- text">Price:15000</p>
              <button type="submit" name="Add_To_Cart" class="btn btn-info">Add To Cart</button>
              <input type="hidden" name="Item_Name" value="Sherwani">
      ...
      <div class="col-lg-3">
        <form action="manage_cart.php" method="POST">
          <div class="card">
            <img src="women6.jpg" class="card-img-top">
            <div class="card-body text-center">
              <h5 class="card-title">Sherwani</h5>
      ...
      <div class="col-lg-3">
        <form action="manage_cart.php" method="POST">
          <div class="card">
            <img src="women7.jpg" class="card-img-top">
            <div class="card-body text-center">
              <h5 class="card-title">T-Shirt</h5>
       ...
       <div class="col-lg-3">
        <form action="manage_cart.php" method="POST">
          <div class="card">
            <img src="women8.jpg" class="card-img-top">
            <div class="card-body text-center">
              <h5 class="card-title">Shirt</h5>
